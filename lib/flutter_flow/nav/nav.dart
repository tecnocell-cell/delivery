...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          ...
          path: '/listaAdicionais',
          builder: (context, params) => ListaAdicionaisWidget(),
        ),
        FFRoute(
          name: 'HomePage',
          path: '/homePage',
        ...
        FFRoute(
          name: 'listaBordas',
          path: '/listaBordas',
          builder: (context, params) => ListaBordasWidget(),
        ),
        FFRoute(
          name: 'listaPizzas',
          path: '/listaPizzas',
          builder: (context, params) => ListaPizzasWidget(),
        ),
        FFRoute(
          name: 'listaLanches',
          path: '/listaLanches',
          builder: (context, params) => ListaLanchesWidget(),
        ),
        FFRoute(
          name: 'listaFritas',
          path: '/listaFritas',
        ...
        FFRoute(
          name: 'testar',
          path: '/testar',
          builder: (context, params) => TestarWidget(),
        ),
        FFRoute(
          name: 'pedidos',
          path: '/pedidos',

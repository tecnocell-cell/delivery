...
import 'lista_categoria_model.dart';
export 'lista_categoria_model.dart';

class ListaCategoriaWidget extends StatefulWidget {
  const ListaCategoriaWidget({Key? key}) : super(key: key);

  @override
  _ListaCategoriaWidgetState createState() => _ListaCategoriaWidgetState();
}

class _ListaCategoriaWidgetState extends State<ListaCategoriaWidget> {
  late ListaCategoriaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaCategoriaModel());

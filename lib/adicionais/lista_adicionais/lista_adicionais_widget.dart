...
import 'lista_adicionais_model.dart';
export 'lista_adicionais_model.dart';

class ListaAdicionaisWidget extends StatefulWidget {
  const ListaAdicionaisWidget({Key? key}) : super(key: key);

  @override
  _ListaAdicionaisWidgetState createState() => _ListaAdicionaisWidgetState();
}

class _ListaAdicionaisWidgetState extends State<ListaAdicionaisWidget> {
  late ListaAdicionaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaAdicionaisModel());

...
import 'garcon_produtos_model.dart';
export 'garcon_produtos_model.dart';

class GarconProdutosWidget extends StatefulWidget {
  const GarconProdutosWidget({Key? key}) : super(key: key);

  @override
  _GarconProdutosWidgetState createState() => _GarconProdutosWidgetState();
}

class _GarconProdutosWidgetState extends State<GarconProdutosWidget>
    with TickerProviderStateMixin {
  late GarconProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => GarconProdutosModel());

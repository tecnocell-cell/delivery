...
import 'testar_model.dart';
export 'testar_model.dart';

class TestarWidget extends StatefulWidget {
  const TestarWidget({Key? key}) : super(key: key);

  @override
  _TestarWidgetState createState() => _TestarWidgetState();
}

class _TestarWidgetState extends State<TestarWidget>
    with TickerProviderStateMixin {
  late TestarModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TestarModel());

...
import 'lista_lanches_model.dart';
export 'lista_lanches_model.dart';

class ListaLanchesWidget extends StatefulWidget {
  const ListaLanchesWidget({Key? key}) : super(key: key);

  @override
  _ListaLanchesWidgetState createState() => _ListaLanchesWidgetState();
}

class _ListaLanchesWidgetState extends State<ListaLanchesWidget> {
  late ListaLanchesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaLanchesModel());

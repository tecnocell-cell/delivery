...
import 'lista_fritas_model.dart';
export 'lista_fritas_model.dart';

class ListaFritasWidget extends StatefulWidget {
  const ListaFritasWidget({Key? key}) : super(key: key);

  @override
  _ListaFritasWidgetState createState() => _ListaFritasWidgetState();
}

class _ListaFritasWidgetState extends State<ListaFritasWidget> {
  late ListaFritasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaFritasModel());

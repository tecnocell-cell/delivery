...
import '/componentes/cad_c_mesas/cad_c_mesas_widget.dart';
...
import 'cad_adicionais_model.dart';
export 'cad_adicionais_model.dart';

class CadAdicionaisWidget extends StatefulWidget {
  const CadAdicionaisWidget({Key? key}) : super(key: key);

  @override
  _CadAdicionaisWidgetState createState() => _CadAdicionaisWidgetState();
}

class _CadAdicionaisWidgetState extends State<CadAdicionaisWidget> {
  late CadAdicionaisModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadAdicionaisModel());

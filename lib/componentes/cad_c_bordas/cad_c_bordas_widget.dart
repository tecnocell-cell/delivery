...
import 'cad_c_bordas_model.dart';
export 'cad_c_bordas_model.dart';

class CadCBordasWidget extends StatefulWidget {
  const CadCBordasWidget({Key? key}) : super(key: key);

  @override
  _CadCBordasWidgetState createState() => _CadCBordasWidgetState();
}

class _CadCBordasWidgetState extends State<CadCBordasWidget>
    with TickerProviderStateMixin {
  late CadCBordasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadCBordasModel());

...
import 'cad_c_produtos_model.dart';
export 'cad_c_produtos_model.dart';

class CadCProdutosWidget extends StatefulWidget {
  const CadCProdutosWidget({Key? key}) : super(key: key);

  @override
  _CadCProdutosWidgetState createState() => _CadCProdutosWidgetState();
}

class _CadCProdutosWidgetState extends State<CadCProdutosWidget> {
  late CadCProdutosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadCProdutosModel());

          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                ...
                validator:
                    _model.nomeProdutoControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator: _model.valorControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              padding: EdgeInsetsDirectional.fromSTEB(20.0, 0.0, 20.0, 16.0),
              child: TextFormField(
                ...
                style: FlutterFlowTheme.of(context).bodyMedium,
                validator:
                    _model.descricaoControllerValidator.asValidator(context),
              ),
            ),
            Padding(
              ...
              child: FlutterFlowDropDown<String>(
                controller: _model.categoriaValueController ??=
                  ...
                  _model.categoriaValue ??= 'Categoria',
                ),
                options: ['Categoria'],

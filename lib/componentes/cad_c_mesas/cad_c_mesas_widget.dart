...
import 'cad_c_mesas_model.dart';
export 'cad_c_mesas_model.dart';

class CadCMesasWidget extends StatefulWidget {
  const CadCMesasWidget({Key? key}) : super(key: key);

  @override
  _CadCMesasWidgetState createState() => _CadCMesasWidgetState();
}

class _CadCMesasWidgetState extends State<CadCMesasWidget>
    with TickerProviderStateMixin {
  late CadCMesasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadCMesasModel());
                ...
                child: Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(
                      labelText: 'Digite o Número da Mesa',

...
import 'lista_bebidas_model.dart';
export 'lista_bebidas_model.dart';

class ListaBebidasWidget extends StatefulWidget {
  const ListaBebidasWidget({Key? key}) : super(key: key);

  @override
  _ListaBebidasWidgetState createState() => _ListaBebidasWidgetState();
}

class _ListaBebidasWidgetState extends State<ListaBebidasWidget> {
  late ListaBebidasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ListaBebidasModel());

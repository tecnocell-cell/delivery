...
import 'cad_categ_model.dart';
export 'cad_categ_model.dart';

class CadCategWidget extends StatefulWidget {
  const CadCategWidget({Key? key}) : super(key: key);

  @override
  _CadCategWidgetState createState() => _CadCategWidgetState();
}

class _CadCategWidgetState extends State<CadCategWidget>
    with TickerProviderStateMixin {
  late CadCategModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadCategModel());
